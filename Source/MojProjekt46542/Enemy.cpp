#include "Enemy.h" #include "Perception/PawnSensingComponent.h" #include "GameFramework/CharacterMovementComponent.h" #include "EnemyController.h" #include "EnemyAnimInstance.h" AEnemy::AEnemy()
{
...
{
	Super::BeginPlay(); _HealthPoints = HealthPoints;
}
void AEnemy::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
	auto animInst = Cast<UEnemyAnimInstance>(
...
void AEnemy::Attack()
{
	GetController()->StopMovement(); _AttackCountingDown = AttackInterval;
}
